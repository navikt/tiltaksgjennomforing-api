...
VALUES (1001, 'TILT', CURRENT_DATE, 'ARBLINJE', CURRENT_DATE, 'BRUKER', 'SAK', 13193683, 2024, 2244, null, 'AKTIV', null, null, null, 'BRUKER', '1219', null, CURRENT_TIMESTAMP(), null, false)
ON CONFLICT DO NOTHING;
...
VALUES (1001, 1001, 'ARBTREN', 1, null, CURRENT_DATE, DATEADD('DAY', 10, CURRENT_DATE), null, null, null, null, null, null, CURRENT_DATE, 'ARBLINJE', CURRENT_DATE, 'BRUKER', null, 'GJENNOMFOR', 100, null, 1001, null, null, null, null, null, '133292332', null, null, null, '1219', '1219', null, null, null, null, null, null, 'NO', null)
ON CONFLICT DO NOTHING;
...
VALUES (1001, 1001, 1001, 'GJENN', 'INNSOKT', null, null, null, 'Syntetisert rettighet', null, CURRENT_DATE, 'BRUKER', CURRENT_DATE, 'BRUKER', null, CURRENT_DATE, DATEADD('DAY', 10, CURRENT_DATE), null, 100, 'BRUKER', CURRENT_DATE, 1, null, null, null, null, null, null, null, null, null, null)
ON CONFLICT DO NOTHING;
