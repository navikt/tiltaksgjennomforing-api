...
insert into maal(ID, OPPRETTET_TIDSPUNKT, KATEGORI, BESKRIVELSE, AVTALE)
values ('ca3d7189-0852-4693-a3dd-d518b4ec42e4', current_timestamp, 'Arbeidserfaring', 'Lære butikkarbeid',
        '5ae3be81-abcd-477e-a8f3-4a5eb5fe91e3');

insert into oppgave (ID, OPPRETTET_TIDSPUNKT, TITTEL, BESKRIVELSE, OPPLAERING, AVTALE)
values ('ca3d7189-0852-4693-a3dd-d518b4ec42e4', current_timestamp, 'Lager', 'Rydde på lageret', 'Ryddekurs',
        '5ae3be81-abcd-477e-a8f3-4a5eb5fe91e3');
...
insert into maal(ID, OPPRETTET_TIDSPUNKT, KATEGORI, BESKRIVELSE, AVTALE)
values ('2cd6fd24-9369-44cd-b8e3-10c4f53762f2', current_timestamp, 'Arbeidserfaring', 'Lære butikkarbeid',
        '8238bedf-d6d9-4145-bcdc-cf857f4bc63f');

insert into oppgave (ID, OPPRETTET_TIDSPUNKT, TITTEL, BESKRIVELSE, OPPLAERING, AVTALE)
values ('2cd6fd24-9369-44cd-b8e3-10c4f53762f2', current_timestamp, 'Lager', 'Rydde på lageret', 'Ryddekurs',
        '8238bedf-d6d9-4145-bcdc-cf857f4bc63f');
