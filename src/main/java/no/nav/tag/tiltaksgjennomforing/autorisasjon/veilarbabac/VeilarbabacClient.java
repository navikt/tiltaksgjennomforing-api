...
public class VeilarbabacClient {
    ...
    public boolean sjekkTilgang(NavIdent navIdent, String fnr, TilgangskontrollAction action) {
        String response;
        try {
            response = hentTilgang(navIdent, fnr, action);
    ...
    private String hentTilgang(NavIdent navIdent, String fnr, TilgangskontrollAction action) {
        ...
        headers.set("subject", navIdent.asString());
    ...
    public void evictAlle() {
    }

    @CacheEvict(cacheNames=CacheConfiguration.ABAC_CACHE)
    public void evict(NavIdent navIdent, String fnr, TilgangskontrollAction action) {
    }
