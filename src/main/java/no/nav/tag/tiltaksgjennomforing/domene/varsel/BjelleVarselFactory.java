...
public class BjelleVarselFactory {
    ...
    public BjelleVarsel deltaker() {
        return BjelleVarsel.nyttVarsel(avtale.getDeltakerFnr(), hendelse.getVarslbarHendelseType());
    }

    public BjelleVarsel arbeidsgiver() {
        return BjelleVarsel.nyttVarsel(avtale.getBedriftNr(), hendelse.getVarslbarHendelseType());
    }

    public BjelleVarsel veileder() {
        return BjelleVarsel.nyttVarsel(avtale.getVeilederNavIdent(), hendelse.getVarslbarHendelseType());
    }
}
