...
public class AltinnVarselConfiguration {
    ...
    public INotificationAgencyExternalBasic iNotificationAgencyExternalBasic() {
        var port = new WsClient<INotificationAgencyExternalBasic>().createPort(varselProperties.getUri().toString(), INotificationAgencyExternalBasic.class, List.of(new LogErrorHandler()), true);
