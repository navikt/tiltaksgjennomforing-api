...
public class Avtale extends AbstractAggregateRoot implements Comparable<Avtale> {
    ...
    public void fylleUtAvtaleGodkjentVersjonVerdier(Avtale sisteAvtaleVersjon, Avtalerolle utfortAv) {
        ...
        registerEvent(new AvtaleLaastOpp(this, utfortAv));
    }

    private void setDeltakerInfo(String deltakerFornavn, String deltakerEtternavn, String deltakerTlf) {
        setDeltakerFornavn(deltakerFornavn);
        setDeltakerEtternavn(deltakerEtternavn);
        setDeltakerTlf(deltakerTlf);
    }

    private void setArbeidsgiverInfo(
    ...
    private void setVeilederInfo(String veilederFornavn, String veilederEtternavn, String veilederTlf) {
        setVeilederFornavn(veilederFornavn);
        setVeilederEtternavn(veilederEtternavn);
        setVeilederTlf(veilederTlf);
    }

    private void setTiltakInfo(
    ...
    /*@JsonProperty("kanlaasesopp")
    public boolean kanlaasesopp(){
AvtaleRepository avtaleRepository;
//AvtaleController avtaleController= new AvtaleController();
if(avtaleRepository.findAllByBaseAvtaleIdAndGodkjentAvVeileder(this.baseAvtaleId,null).size()>0)
    return false;
return true;
    }*/
