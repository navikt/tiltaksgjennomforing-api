...
public class AvtaleController {
    ...
    public ResponseEntity<?> endreAvtale(
        ...
        Avtale avtale = avtaleRepository.findById(avtaleId)
                .map(avtaleService::sjekkArbeidstreningToggle)
    ...
    public ResponseEntity<?> opprettAvtaleSomArbeidsgiver(@RequestBody OpprettAvtale opprettAvtale) {
        ...
        avtaleService.sjekkArbeidstreningToggle(avtale);
    ...
    public void endreTilskuddsberegning(@PathVariable("avtaleId") UUID avtaleId,
        ...
        avtaleService.endreTilskuddsberegning(avtaleId, endreTilskuddsberegning, false);
    }
    ...
    public Avtale endreTilskuddsberegningDryRun(
        ...
        return avtaleService.endreTilskuddsberegning(avtaleId, endreTilskuddsberegning, true);
    }
