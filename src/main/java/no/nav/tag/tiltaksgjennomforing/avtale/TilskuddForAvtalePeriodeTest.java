...
public class TilskuddForAvtalePeriodeTest {
    ...
    public void beregnTilskuddFor3KalenderMåneder() {
        ...
        List<TilskuddPeriode> list = TilskuddForAvtalePeriode.beregnTilskuddForAvtalePerioden(månedslønn, datoFom, datoTom);
    ...
    public void lagerEnRefusjonsperiode() {
        ...
        List<TilskuddPeriode> perioder = TilskuddForAvtalePeriode.beregnTilskuddForAvtalePerioden(20000, datoFom, datoTom);
    ...
    public void lag2RefusjonerOgEndag() {
        ...
        List<TilskuddPeriode> perioder = TilskuddForAvtalePeriode.beregnTilskuddForAvtalePerioden(20000, avtaleStartDato, avtaleSluttDato);
