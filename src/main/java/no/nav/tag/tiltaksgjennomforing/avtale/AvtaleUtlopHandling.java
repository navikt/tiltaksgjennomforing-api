...
public enum AvtaleUtlopHandling {
    ...
    public static final Instant START_DATO_FOR_RYDDING = Instant.parse("2024-11-28T12:00:00.000+01:00");
    ...
    public static AvtaleUtlopHandling parseDangerously(Avtale avtale) {
