...
import no.nav.tag.tiltaksgjennomforing.logging.TeamLog;
...
public class Veileder extends Avtalepart<NavIdent> implements InternBruker {
    private static final TeamLog teamLog = TeamLog.getLogger(log);
    ...
    public Tilgang harTilgangTilAvtale(Avtale avtale) {
        teamLog.info("Sjekker tilgang for veileder {} til avtale {}", getIdentifikator(), avtale.getId());
