...
@Configuration
@EnableKafka
public class TilskuddsperiodeOppdatertStatusConsumerConfig {
    ...
    public ConsumerFactory<String, TilskuddsperiodeOppdatertStatusMelding> tilskuddsperiodeStatusConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props,
                ...
                new JsonDeserializer<>(TilskuddsperiodeOppdatertStatusMelding.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TilskuddsperiodeOppdatertStatusMelding> tilskuddsperiodeOppdatertStatusContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, TilskuddsperiodeOppdatertStatusMelding>();
        factory.setConsumerFactory(tilskuddsperiodeStatusConsumerFactory());
        return factory;
    }
}
