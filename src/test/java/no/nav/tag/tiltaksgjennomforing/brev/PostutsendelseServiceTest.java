...
public class PostutsendelseServiceTest {
    ...
    @Test
    public void validerAtPersonKanMottaPost__skal_ikke_feile_nar_person_har_adresse_og_ikke_er_reservert() {
        ...
        assertThatCode(() -> postutsendelseService.validerAtPersonKanMottaPost(FNR)).doesNotThrowAnyException();
    }

    @Test
    public void validerAtPersonKanMottaPost__skal_feile_nar_person_mangler_adresse_og_er_reservert() {
        ...
        assertFeilkode(
            ...
            () -> postutsendelseService.validerAtPersonKanMottaPost(FNR)
        );
    }

    @Test
    public void validerAtPersonKanMottaPost__skal_ikke_feile_nar_person_kun_mangler_adresse() {
        when(postadresseClient.sjekkOmPersonErRegistrertMedAdresse(FNR)).thenReturn(false);
        when(digitalKontaktinformasjonClient.erPersonReservertMotDigitalKontakt(FNR)).thenReturn(false);
    ...
    @Test
    public void validerAtPersonKanMottaPost__skal_ikke_feile_nar_person_kun_er_reservert() {
        when(postadresseClient.sjekkOmPersonErRegistrertMedAdresse(FNR)).thenReturn(true);
        when(digitalKontaktinformasjonClient.erPersonReservertMotDigitalKontakt(FNR)).thenReturn(true);
