...
public class InkluderingstilskuddTest {
    ...
    public void endreInkluderingstilskudd_verifisere_enkel_endring() {
        ...
        avtale.endreAvtale(avtale.getSistEndret(), TestData.endringPåAlleInkluderingstilskuddFelter(), Avtalerolle.VEILEDER, EnumSet.of(avtale.getTiltakstype()), List.of());
    }
