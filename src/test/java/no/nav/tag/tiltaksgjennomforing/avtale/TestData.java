...
<<<<<<< HEAD
        avtale.endreAvtale(
                ...
                endringPåAlleArbeidstreningFelter(),
...
>>>>>>> master
    ...
    public static Avtale enLonnstilskuddAvtaleMedAltUtfyltMedGodkjentForEtterregistrering(
            LocalDate avtaleStart,
            LocalDate avtaleSlutt
    ) {
        Avtale avtale = TestData.enMidlertidigLonnstilskuddAvtaleMedAltUtfylt();
        avtale.setKvalifiseringsgruppe(Kvalifiseringsgruppe.VARIG_TILPASSET_INNSATS);
        EndreAvtale endring = TestData.endringPåAlleLønnstilskuddFelter();
...
>>>>>>> master
    ...
    public static EndreInkluderingstilskudd endringMedNyeInkluderingstilskudd(
            List<Inkluderingstilskuddsutgift> eksisterendeUtgifter
    ) {
        ...
        endreInkluderingstilskudd.getInkluderingstilskuddsutgift()
                .add(TestData.enInkluderingstilskuddsutgiftUtenId(
                        13337,
                        InkluderingstilskuddsutgiftType.PROGRAMVARE
                ));
...
<<<<<<< HEAD
    public static EndreAvtale endreInkluderingstilskuddInfo(EndreAvtale endreAvtale){
        endreAvtale.getInkluderingstilskuddsutgift()
                .add(TestData.enInkluderingstilskuddsutgift(13337, InkluderingstilskuddsutgiftType.PROGRAMVARE));
        endreAvtale.getInkluderingstilskuddsutgift()
                .add(TestData.enInkluderingstilskuddsutgift(25697, InkluderingstilskuddsutgiftType.OPPLÆRING));
        endreAvtale.getInkluderingstilskuddsutgift()
                .add(TestData.enInkluderingstilskuddsutgift(7195, InkluderingstilskuddsutgiftType.UTSTYR));
        endreAvtale
                .setInkluderingstilskuddBegrunnelse("Behov for tilskudd av programvarelisenser og opplæring.");
=======
    public static EndreAvtale endreInkluderingstilskuddInfo(EndreAvtale endreAvtale) {
...
>>>>>>> master
    ...
    public static EndreAvtale endringPåAlleLønnstilskuddFelter() {
        ...
        endreAvtale.setAntallDagerPerUke(5);
        endreAvtale.setRefusjonKontaktperson(
                new RefusjonKontaktperson(
                        "Ola",
                        "Olsen",
                        "12345678",
    ...
    public static Inkluderingstilskuddsutgift enInkluderingstilskuddsutgift(
            Integer beløp,
            InkluderingstilskuddsutgiftType type
    ) {
    ...
    public static Inkluderingstilskuddsutgift enInkluderingstilskuddsutgiftUtenId(
            Integer beløp,
            InkluderingstilskuddsutgiftType type
    ) {
        Inkluderingstilskuddsutgift i = new Inkluderingstilskuddsutgift();
    ...
    public static InnloggetArbeidsgiver innloggetArbeidsgiver(Avtalepart<Fnr> avtalepartMedFnr, BedriftNr bedriftNr) {
        ...
        AltinnReportee altinnOrganisasjon = new AltinnReportee(
                "Bedriften AS",
                "Business",
                bedriftNr.asString(),
                "BEDR",
    ...
    public static Avtale enAvtaleMedFlereVersjoner() {
        ...
        avtale.endreKontaktInformasjon(
                new EndreKontaktInformasjon("Atle",
                        "Jørgensen",
    ...
    public static BedriftNr etBedriftNr() { return new BedriftNr("777777777"); }
    ...
    public static Veileder enVeileder(Avtale avtale, PersondataService persondataService) {
        TilgangskontrollService tilgangskontrollService = mock(TilgangskontrollService.class);
        KontoregisterService kontoregisterService = mock(KontoregisterService.class);
        when(tilgangskontrollService.harSkrivetilgangTilKandidat(avtale.getVeilederNavIdent(), avtale.getDeltakerFnr()))
                .thenReturn(true);
    ...
    public static PdlRespons enPdlrespons(boolean harKode6) {
        ...
        HentPerson hentPerson = new HentPerson(
                adressebeskyttelser,
                new Navn[]{ new Navn("Donald", null, "Duck") }
        );
        return new PdlRespons(
                new Data(
                        hentPerson,
                        null,
                        new HentGeografiskTilknytning(null, "030101", null, null)
                )
        );
    }
    ...
    public static EndreTilskuddsberegning enEndreTilskuddsberegning() {
        ...
        return EndreTilskuddsberegning.builder()
                .otpSats(otpSats).feriepengesats(feriepengesats)
                .arbeidsgiveravgift(arbeidsgiveravgift).manedslonn(manedslonn).build();
    }
...
<<<<<<< HEAD
        avtale.endreAvtale(
                avtale.getSistEndret(),
                endringPåAlleLønnstilskuddFelter(),
                Avtalerolle.VEILEDER,
                EnumSet.of(avtale.getTiltakstype()),
                List.of(),
                List.of()
