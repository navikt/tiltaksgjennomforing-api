...
public class AvtaleControllerTest {
    ...
    public void opprettAvtaleSkalReturnereCreatedOgOpprettetLokasjon() {
        ...
        when(veilarbArenaClient.sjekkOgHentOppfølgingStatus(opprettAvtale)).thenReturn(new Oppfølgingsstatus("ARBS", Kvalifiseringsgruppe.SITUASJONSBESTEMT_INNSATS, "0906"));
