...
public class AvtaleTest {
    ...
    public void forleng_over_24_mnd_midl_lts() {
        Avtale avtale = TestData.enLonnstilskuddAvtaleGodkjentAvVeileder();
        assertFeilkode(Feilkode.VARIGHET_FOR_LANG_MIDLERTIDIG_LONNSTILSKUDD, () -> avtale.forlengAvtale(avtale.getGjeldendeInnhold().getStartDato().plusMonths(24).plusDays(1), TestData.enNavIdent()));
    }
