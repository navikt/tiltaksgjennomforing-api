...
public class TilgangUnderPiloteringTest {
    ...
    @Test(expected = TilgangskontrollException.class)
    public void sjekkTilgang__enabled__og_axsys_feiler_skal_feile() {
        when(axsysService.hentEnheterVeilederHarTilgangTil(new NavIdent("Q000111"))).thenThrow(new RestClientException("mock exception"));
        tilgangUnderPilotering.sjekkTilgang(new NavIdent("Q000111"));
    }
