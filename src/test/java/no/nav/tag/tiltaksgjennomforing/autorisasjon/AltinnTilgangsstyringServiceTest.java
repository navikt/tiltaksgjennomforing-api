...
public class AltinnTilgangsstyringServiceTest {
    ...
    public void hentOrganisasjoner__tilgang_bare_for_arbeidstrening() {
        ...
        assertThat(tilganger.get(new BedriftNr("999999999"))).containsOnly(
                ...
                Tiltakstype.SOMMERJOBB, Tiltakstype.MENTOR, Tiltakstype.INKLUDERINGSTILSKUDD, Tiltakstype.VTAO, Tiltakstype.FIREARIG_LONNSTILSKUDD); // TODO: Tilgangsstyring skal skille på midlertidig lønnstilskudd og sommerjobb
    }
