...
public class AltinnTilgangsstyringServiceTest {
    ...
    public void hentOrganisasjoner__gyldig_fnr_en_bedrift_pa_hvert_titlak() {
        ...
        assertThat(organisasjoner).extracting("bedriftNr").containsOnly(new BedriftNr("999999999"), new BedriftNr("910712314"), new BedriftNr("910712306"), new BedriftNr("910825550"));
    }
    ...
    public void hentOrganisasjoner__skal_ha_parentOrganization() {
        ...
        AltinnOrganisasjon organisasjon = organisasjoner.stream().filter(org -> org.getOrganizationNumber().equals("910825607")).findFirst().get();
