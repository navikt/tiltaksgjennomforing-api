...
class KvalifiseringsgruppeTest {
    ...
    void is_equal_to_innsatsgruppe_matcher_ikke_annen_innsatsgruppe() {
        ...
        assertFalse(Kvalifiseringsgruppe.SPESIELT_TILPASSET_INNSATS.isEqualToInnsatsgruppe(Innsatsgruppe.LITEN_MULIGHET_TIL_A_JOBBE));
    }
    ...
    void is_equal_to_innsatsgruppe_varig_tilpasset_matcher_begge_varige_varianter() {
        ...
        assertFalse(Kvalifiseringsgruppe.VARIG_TILPASSET_INNSATS.isEqualToInnsatsgruppe(Innsatsgruppe.GODE_MULIGHETER));

        assertTrue(Kvalifiseringsgruppe.GRADERT_VARIG_TILPASSET_INNSATS.isEqualToInnsatsgruppe(Innsatsgruppe.LITEN_MULIGHET_TIL_A_JOBBE));
        assertTrue(Kvalifiseringsgruppe.GRADERT_VARIG_TILPASSET_INNSATS.isEqualToInnsatsgruppe(Innsatsgruppe.JOBBE_DELVIS));

        assertFalse(Kvalifiseringsgruppe.GRADERT_VARIG_TILPASSET_INNSATS.isEqualToInnsatsgruppe(Innsatsgruppe.GODE_MULIGHETER));
    }
